    % This file is a modified version of a function from the gptoolbox:
    % https://github.com/alecjacobson/gptoolbox
    %
    % Original work copyright (c) Alec Jacobson
    % Modified by Ruben Doste, 2024
    %
...
function [D,u,X,div_X,phi,pre,B,t] = heat_geodesic_modified2t(varargin)
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   %DTPhi is the previously obtained gradient
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %   t  time parameter
  %   Optional:
