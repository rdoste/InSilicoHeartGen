...
function [face2,label2,label_tetra_msh]=msh_septum_creation(v2,elem,face,labelp,Tphi,label,body1,label_tetra,body1_Threshold,Surface_tag1,Surface_tag2)
%function that generates the septal surfaces and all the variables required
%for the septal field calculation
%body1--> the elements of the RV and LV
              ...
              if max(labelp)==12 %with valves
                labelsept(labelsept==2 | labelsept==12 )=Surface_tag2;
              elseif max(labelp)==5 %cut geo
                labelsept(labelsept==1 | labelsept==5)=Surface_tag2;
              end
              points_sept2=points_sept(labelsept~=Surface_tag2);           
